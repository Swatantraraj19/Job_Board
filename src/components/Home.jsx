    ...
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto">
      <div className="text-center py-20 px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold text-zinc-900 dark:text-white mb-6 tracking-tight">
          Find the{" "}
          <span className="text-indigo-600 dark:text-indigo-400">Work</span> You
          Love.
        </h1>
        <p className="text-xl text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          The curated job board for developers, designers, and creators. Powered
          by real-time Hacker News data. Simple, fast, and no-nonsense.
        </p>
