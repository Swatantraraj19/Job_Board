      ...
      <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-sm border border-zinc-200 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-zinc-700 ml-1 uppercase tracking-wide">
              Username
            </label>
          ...
          <button
            type="button"
            className="w-full bg-white text-zinc-700 border border-zinc-200 py-2.5 rounded-lg font-medium text-sm hover:bg-zinc-50 transition-colors flex items-center justify-center gap-2"
          >
